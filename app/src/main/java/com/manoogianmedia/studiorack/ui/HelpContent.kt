...
internal fun studioLeviathanHelpSections(
    ...
    HelpSection(
        ...
        listOf(
            ...
            HelpTopic("Workspace Modules", listOf("Open More > Modules to see the workspace's operating profile and effective modules. Owners and Account Managers can select a different focus, such as Individual Musician, Band or Ensemble, Recording Studio, Live Production Company, or Worship Organization. Changing focus updates specialized choices and forms but never deletes existing records, values, reports, or exports.", "A workspace focus does not automatically grant separately priced modules. Workspace Owners can open Manage Module Billing to choose available specialized modules; access appears on Android after synchronization.", "Open More > Module Data to review workspace-wide choices and each enabled module's categories, equipment types, and specialized options. Workspace extensions remain private, and a value from an inactive module remains available whenever existing equipment still uses it.")),
