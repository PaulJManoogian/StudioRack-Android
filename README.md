...
Version 0.11.1 adds owner-side share management so outgoing access can be edited, redelivered, copied, and revoked from Android with the same live authorization rules as the web application.
