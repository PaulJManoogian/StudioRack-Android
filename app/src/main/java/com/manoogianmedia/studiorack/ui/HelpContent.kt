...
internal fun studioLeviathanHelpSections(
    ...
    HelpSection(
        ...
        listOf(
            ...
            HelpTopic("Post-Performance Check-In", listOf("After a newly scheduled performance is complete, Crew checks in once after a short delay. Reply naturally with anything damaged or missing, maintenance that may be needed, or a follow-up that should not be forgotten.", "Replying is optional. An unanswered check-in closes quietly after 48 hours. Clear no-issue replies close immediately; reported issues become a reviewable summary and do not change equipment, maintenance, or session records until a person confirms the next action.")),
