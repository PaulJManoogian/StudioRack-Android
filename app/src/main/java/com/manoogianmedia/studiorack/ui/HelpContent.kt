...
internal fun studioLeviathanHelpSections(
    ...
    HelpSection(
        ...
        listOf(
            ...
            HelpTopic("Finding And Using Events", listOf("Search and filter by event details, type, and status. Event actions open $liveName, People, editing, copying, printing, sharing, and deletion. People provides group communication and individual call, text, email, and profile actions.")),
